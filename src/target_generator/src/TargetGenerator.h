...
#define D 2
float ALPHA = 0.3;       // alpha parameter
int GAMMA = 0.4;     // gamma parameter
...
/*Firefly no Paradigma Estrutural - Jorge Rodrigo*/
    //TO_DO - Adaptar para o paradigma Orientado a Objetos

typedef struct {
        double          *var;//Para o fitness - ACMO
        double          fitness; // Equivalente a atratividade do vagalume
